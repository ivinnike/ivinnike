...
<div id="badges" align="center">
 ...
 </br>:small_blue_diamond: Понимание клиент-серверной архитектуры (тестирование клиент(программу (web или desktop)); тестирование сервер (смотрим логи; нагрузочное тестирование); тестирование SQL; тестирование безопасности).
