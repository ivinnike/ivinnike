...
<div id="badges" align="center">
 ...
 </br>:small_blue_diamond: Понимание клиент-серверной архитектуры (тестирование клиент(программу (web или desktop)); тестирование сервер (смотрим логи; тестирование производительности ); тестирование SQL; тестирование безопасности).
 </br>:small_blue_diamond: Язык разметки HTML5 и язык CSS.
